...
bookshelf-engine/1.3.0 darwin-x64 node-v8.12.0
...
_See code: [src/commands/build.ts](https://github.com/chpwssn/bookshelf-engine/blob/v1.3.0/src/commands/build.ts)_
